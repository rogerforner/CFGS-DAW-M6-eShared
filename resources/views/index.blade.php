      ...
      <div class="card border-primary mb-4">
        <div class="card-body">
          <div class="card-body">
            ...
            <p class="text-justify">Penja apunts de qualitat de forma gratuïta i quan rebis una puntuació satisfactoria podràs consumir els apunts dels/les altres usuaris/ries</p>
          </div>
      ...
      <div class="card border-primary">
        <div class="card-body">
          <div class="card-body">
            ...
            <p class="text-justify">Penja apunts de qualitat de forma gratuïta i consumeix-los directament sense la necessitat d'esperar a que siguin puntuats.</p>
          </div>
          <ul class="list-group list-group-flush">
    ...
    <div class="col">
      <div class="card shadow-2">
        <div class="card-body">
          ...
          <p class="text-justify">El nom del nostre equip s’esdevé arran de la coneixença del significat de les sigles GNU, on la lletra G representa les tres sigles (fent-ne una reiteració de les tres sigles) i on la resta de lletres representen Not Unix.</p>
          <img src="{{ asset('img/gnu.png') }}" alt="GNU" class="img-thumbnail">

          <p class="mt-4 text-justify">Explicat això podem desglossar el nom del nostre grup GSPD, definint cadascuna de les seves sigles.</p>
          <img src="{{ asset('img/gspd.png') }}" alt="GSPD" class="img-thumbnail">

          <p class="mt-4 text-justify">G[SPD] Smart Programming Developers (GSPD) està format per:</p>
          <ul>
          ...
          <p class="mt-4 text-justify">Tots tres membres de l'equip som estudiants de <em>Desenvolupament d'Aplicacions Web</em> (2n) de l'<a href="http://agora.xtec.cat/insmontsia/" target="_blank">Institut Montsià</a>, Amposta (Terres de l'Ebre).</p>
        </div>
      </div><!-- /.card -->
    </div><!-- /.col -->
  </div><!-- /.row -->
      ...
      <div class="col">
        <div class="card shadow-2">
          <div class="card-body">
            ...
            <p class="text-justify">Pots descarregar el codi del nostre projecte en el sgüent enllaç:</p>
            <ul>
